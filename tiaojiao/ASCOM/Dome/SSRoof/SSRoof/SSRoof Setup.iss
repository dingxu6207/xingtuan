...
; Generated by graycode on 2019/9/2 (UTC)
;
[Setup]
AppID={{59fcc776-aed7-4685-a30e-e51e2f0689eb}
AppName=ASCOM SSRoof Dome Driver
AppVerName=ASCOM SSRoof Dome Driver 1.0.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="SSRoof Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\SSRoof"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\SSRoof"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\wk\ASCOM\Dome\SSRoof\SSRoof\bin\Release\ASCOM.SSRoof.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\wk\ASCOM\Dome\SSRoof\SSRoof\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSRoof.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SSRoof.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SSRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
