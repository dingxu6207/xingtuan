...
; Generated by www.graycode.cn on 2017-11-26 (UTC)
;
[Setup]
AppID={{1b716380-e392-4166-a514-8d2098811b92}
AppName=ASCOM SSFC Dome Driver
AppVerName=ASCOM SSFC Dome Driver 1.0
AppVersion=1.0
AppPublisher=www.graycode.cn <graycode@qq.com>
...
OutputDir="."
OutputBaseFilename="SSFC Dome Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\SSFC"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\SSFC"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Projects\ASCOM\Dome\SS\SS\bin\Release\ASCOM.SSFC.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Projects\ASCOM\Dome\SS\SS\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSFC.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSFC.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SSFC.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SSFC.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SSFC.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
