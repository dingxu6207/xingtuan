...
namespace CAO
{
    public class SSObservingConditions
    {
        /// <summary>
        ...
        public ASCOM.DriverAccess.ObservingConditions MySSObservingConditions;

        internal static string driverID = "ASCOM.TObsCon.ObservingConditions";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM ObservingConditions Driver for TObsCon.";
        ...
        public void SetupDialog()
        {
            if (MyDriverType == 0)
            {
                MySSObservingConditions.SetupDialog();
            }
            else
            {
        ...
        public ArrayList SupportedActions
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.SupportedActions;
                }
                else
                {
        ...
        public string Action(string actionName, string actionParameters)
        {
            if (MyDriverType == 0)
            {
                return MySSObservingConditions.Action(actionName, actionParameters);
            }
            else
            {
        ...
        public void Dispose()
        {
            if (MyDriverType == 0)
            {
                MySSObservingConditions.Dispose();
            }
            else
            {
        ...
        public bool Connected
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Connected;
                }
                else
                {
            ...
            set
            {
                if (MyDriverType == 0)
                {
                    MySSObservingConditions.Connected = value;
                }
                else
                {
        ...
        public string Description
        {
            ...
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Description;
                }
                else
                {
        ...
        public string DriverInfo
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.DriverInfo;
                }
                else
                {
        ...
        public string DriverVersion
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.DriverVersion;
                }
                else
                {
                    Version version = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version;
        ...
        public short InterfaceVersion
        {
            ...
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.InterfaceVersion;
                }
                else
                {
        ...
        public string Name
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Name;
                }
                else
                {
        ...
        public double AveragePeriod
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.AveragePeriod;
                }
                else
                {
            ...
            set
            {
                if (MyDriverType == 0)
                {
                    MySSObservingConditions.AveragePeriod = value;
                }
                else
                {
        ...
        public double CloudCover
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.CloudCover;
                }
                else
                {
        ...
        public double DewPoint
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.DewPoint;
                }
                else
                {
        ...
        public double Humidity
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Humidity;
                }
                else
                {
        ...
        public double Pressure
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Pressure;
                }
                else
                {
        ...
        public double RainRate
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.RainRate;
                }
                else
                {
        ...
        public void Refresh()
        {
            if (MyDriverType == 0)
            {
                MySSObservingConditions.Refresh();
            }
            else
            {
        ...
        public string SensorDescription(string PropertyName)
        {
            if (MyDriverType == 0)
            {
                return MySSObservingConditions.SensorDescription(PropertyName);
            }
            else
            {
        ...
        public double SkyBrightness
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.SkyBrightness;
                }
                else
                {
        ...
        public double SkyQuality
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.SkyQuality;
                }
                else
                {
        ...
        public double StarFWHM
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.StarFWHM;
                }
                else
                {
        ...
        public double SkyTemperature
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.SkyTemperature;
                }
                else
                {
        ...
        public double Temperature
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.Temperature;
                }
                else
                {
        ...
        public double WindDirection
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.WindDirection;
                }
                else
                {
        ...
        public double WindGust
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.WindGust;
                }
                else
                {
        ...
        public double WindSpeed
        {
            get
            {
                if (MyDriverType == 0)
                {
                    return MySSObservingConditions.WindSpeed;
                }
                else
                {
