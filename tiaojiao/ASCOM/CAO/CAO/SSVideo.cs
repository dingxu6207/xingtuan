...
namespace CAO
{
    public class SSVideo
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.TVideo.Video";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Video Driver for TVideo.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TVideo"/> class.
        /// Must be public for COM registration.
        /// </summary>
        public SSVideo(string DriverID, byte DriverType)
        {
            tl = new TraceLogger("", "TVideo");
